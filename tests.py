...
# test1a_error = distance.euclidean(
#     itrs.cartesian.xyz._to_value(u.m), gcrs2irts_matrix_a(t, eop) @ xyz1
# )
# test1b_error = distance.euclidean(
#     itrs.cartesian.xyz._to_value(u.m), gcrs2irts_matrix_b(t, eop) @ xyz1
# )
...
# observer = EarthLocation.from_geocentric(
#     x=xyz1[0] * u.m, y=xyz1[1] * u.m, z=xyz1[2] * u.m
# )
# target = SkyCoord(
#     x=xyz2[0] * u.m,
#     y=xyz2[1] * u.m,
...
# end = time.time()
# print(
#     "Test 4a: Time to generate cel2ter transformation matrix with gcrs2irts_matrix_a for every 30 seconds for an entire day: ",
#     end - start,
#     " seconds",
# )
...
# end = time.time()
# print(
#     "Test 4b: Time to generate cel2ter transformation matrix with gcrs2irts_matrix_b for every 30 seconds for an entire day: ",
#     end - start,
#     " seconds",
# )
...
# print(
#     "Test 5a: Cel2Ter06aXY vs Cel2Ter94, magnitude of error: ",
#     det(Cel2Ter06aXY - Cel2Ter94),
# )
# print(
#     "Test 5b: Cel2Ter06aXY vs Cel2Ter00aCIO, magnitude of error: ",
#     det(Cel2Ter06aXY - Cel2Ter00aCIO),
# )
# print(
#     "Test 5c: Cel2Ter06aXY vs Cel2Ter00aEB, magnitude of error: ",
#     det(Cel2Ter06aXY - Cel2Ter00aEB),
# )
# print(
#     "Test 5d: Cel2Ter06aXY vs Cel2Ter06aCA, magnitude of error: ",
#     det(Cel2Ter06aXY - Cel2Ter06aCA),
# )
# print(
#     "Test 5e: Cel2Ter06aXY vs gcrs2irts_matrix, magnitude of error: ",
#     det(Cel2Ter06aXY - gcrs2irts_matrix_a(t, eop)),
# )
# print(
#     "Test 5f: Cel2Ter06aXY vs utc2cel06acio, magnitude of error: ",
#     det(Cel2Ter06aXY - gcrs2irts_matrix_b(t, eop)),
# )
...
# x = np.array(
#     [34090858.3, 23944774.4, 6503066.82, -1983.785080, 2150.41744, 913.881611]
# )  # [meters x 3, meters / second x3]
...
# noise = Q_discrete_white_noise(
#     dim=2, dt=dt, var=0.000001**2, block_size=3, order_by_dim=False
# )
...
# assert test6b < 1.0e-4, print(
#     "Test 6b: Prediction off by more than 1.0e-4 meter/second"
# )

# print(
#     "Test 6: step 50 errors: pos: ",
#     test6a,
#     " (meters), vel: ",
#     test6b,
#     " (meters / second)",
...
# # assert test7b < 1.0e-2, print(
# #     "Test 7b: Prediction off by more than 1.0e-2 meter/second"
# # )

# # print(
# #     "Test 7: step 50, 1 update errors: pos: ",
# #     test7a,
# #     " (meters), vel: ",
# #     test7b,
# #     " (meters / second)",
# # )
# # print(
# #     "The update improves the location accuracy, but the velocity was not observed and the update degrades its estimate"
# # )
...
# # assert test7d < 1.0e-2, print(
# #     "Test 7d: Prediction off by more than 1.0e-2 meter/second"
# # )

# # print(
# #     "Test 7: step 100, 2 update errors: pos: ",
# #     test7c,
# #     " (meters), vel: ",
# #     test7d,
# #     " (meters / second)",
...
# #     [ecef2aer(observer_lla, sat_sample, observer_itrs) for sat_sample in sat_samples]
# # )
# # obs_mean = ecef2aer(observer_lla, sat_mean, observer_itrs)
# # obs_mean_calc = mean_z(
# #     obs_samples, Wm=np.repeat(1 / obs_samples.shape[0], obs_samples.shape[0])
# # )
...
# # print(
# #     "Test 10a: hx error in azimuth (arc seconds) = ", np.degrees(hx_error[0]) * 60 * 60
# # )
# # print(
# #     "Test 10b: hx error in elevation (arc seconds) = ",
...
# #     dim=2, dt=dt, var=0.0001**2, block_size=3, order_by_dim=False
# # )
...
# # test11a_error = [
# #     distance.euclidean(ukf.x[:3], x_true[:3]),
# #     distance.euclidean(ukf.x[3:], x_true[3:]),
# # ]
...
# #     max_step,
# #     " error after ",
# #     int(max_step / obs_interval),
# #     " updates (FilterPy): ",
# #     np.round(test11a_error[0], 4),
# #     " meters, ",
# #     np.round(test11a_error[1], 4),
# #     " meters per second",
# # )
...
# # print(
# #     "Test 11b: Time to complete 500 steps using FilterPy prediction: ",
# #     np.round(timeit.timeit(time_filterpy_predict, number=500), 4),
# #     " seconds",
# # )
...
# #     " error after ",
# #     int(max_step / obs_interval),
# #     " updates (FilterPy with noise): ",
# #     np.round(test12a_error[0], 4),
# #     " meters, ",
# #     np.round(test12a_error[1], 4),
# #     " meters per second",
# # )
# # print(
# #     "Test 12a: step ",
...
# #     int(max_step / obs_interval),
# #     " updates (FilterPy with noise): ",
# #     np.round(np.sqrt(np.sum(np.diag(ukf.P)[:3])), 4),
# #     " meters, ",
# #     np.round(np.sqrt(np.sum(np.diag(ukf.P)[3:])), 4),
# #     " meters per second",
# # )
...
# # env.plot_map() # TODO: needs fixing
# env.plot_actions(save_path=None)
# # env.plot_rewards() # TODO: needs fixing
# env.plot_innovation_bounds(save_path=None)
# # env.plot_regimes(save_path=None) # TODO: needs fixing
