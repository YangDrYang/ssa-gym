...
env_config = {
    ...
    "obs_limit": 15,
    "observer": (38.828198, -77.305352, 20.0),
    "update_interval": 1,
    "obs_type": "aer",
    "z_sigma": (1, 1, 1e3),
    "x_sigma": tuple([1e5] * 3 + [1e2] * 3),
    "q_sigma": 0.000025,
    "P_0": np.diag(([1e5**2] * 3 + [1e2**2] * 3)),
...
import ray
from ray.rllib.agents.dqn import DEFAULT_CONFIG, DQNTrainer
